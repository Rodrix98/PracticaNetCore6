...
public partial class DbventaCore6Context : DbContext
{
    public DbventaCore6Context()
    {
    }

    public DbventaCore6Context(DbContextOptions<DbventaCore6Context> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CF053A4E2");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F870D93A1");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483C9401A9B");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E10704771DC4");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547EBBBB9AF6");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1323DBE9D95");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F767066E908");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D88639C678");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEFB5994B1");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6C65EC193");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56146CF679C3");
