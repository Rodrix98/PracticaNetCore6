...
$(document).ready(function () {
    ...
    //OBTIENE LA LISTA DE TIPOS DE DOCUMENTOS PARA UNA NUEVA VENTA
    ...
    // OBTIENE EL TIPO DE MONEDA UTILIZADA POR EL NEGOCIO
    ...
    $("#cboBuscarProducto").select2({
        ajax: {
            ...
            data: function (params) {
                return {
                    //el nombre del parametro es "busqueda" porque asi esta definido en el controlador "/Venta/ObtenerProductos"
            ...
            processResults: function (data) {
                ...
                return {
                    results: data.map((item) => (
                        {
                            //segun la documentacion, siempre se requiere un "id" y un "text", luego podemos agregar lo que deseemos a la estructura
                            id: item.idProducto,
