...
namespace SistemaVenta.AplicacionWeb.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, IUsuarioService usuarioServicio, IMapper mapper)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> CambiarClave([FromBody] VMCambiarClave modelo)
        {
            ...
            try
            {
                ...
                bool resultado = await _usuarioServicio.CambiarClave(int.Parse(idUsuario), modelo.ClaveActual, modelo.ClaveNueva);
